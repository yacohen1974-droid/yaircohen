    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-56 pb-32 px-4 md:px-8 xl:px-24">
        <div className="max-w-4xl mx-auto text-right">
          <SectionTitle subtitle="Legal" title="מדיניות Privacy" />
          <div className="boutique-para space-y-8 mt-12">
            <p>Privacyכם חשובה לנו. דף זה מפרט כיצד אנו אוספים ומשתמשים במידע שלכם.</p>
            ...
            <p>המידע משמש לContact Us ראשוני ולתיאום פגישות. אנו לא מעבירים את המידע שלכם לצד ג' ללא אישור מפורש.</p>
